...
{
    /// <summary>
    /// Provides compatibility helpers to query the player's stealth or crouch state across different builds and overhauls.
    /// </summary>
    public static class PlayerStateUtility
    {
        /// <summary>
        /// Returns true when the player is crouching or otherwise in a stealth state.
        /// </summary>
